...
use Closure;
use JSzD\VanillaCookieConsent\Helpers\Str;
...
class CookiesRegistrar {
    ...
    /**
     * Create & configure a new cookie consent-category.
     */
    ...
    /**
     * Check if a given function is expecting a category instance as the first parameter.
     */
