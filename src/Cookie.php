...
use JSzD\VanillaCookieConsent\Concerns;

/**
 * @method static Cookie name(string $name)
 * @method static Cookie duration(int $minutes)
 * @method static Cookie description(string $value)
 */
class Cookie {
